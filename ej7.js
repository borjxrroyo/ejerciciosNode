...
const cadena = `Hola! ${req.body.nombre}`           // Variables en BODY porque es tipo POST. Así no se alarga la URL - Se define una constante "cadena" que incluye un string con "Hola! " + la variable "nombre" pedida en la barra de direcciones
...
// GET: Las variables se ubican en la barra de direcciones
